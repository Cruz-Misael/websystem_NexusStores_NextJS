        ...
        <div className="w-full max-w-[400px] space-y-8">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="flex items-center justify-center gap-2 px-4 py-2.5 border border-zinc-200 rounded-xl hover:bg-zinc-50 transition-all font-bold text-[11px] uppercase tracking-wider text-zinc-700 disabled:opacity-60 disabled:cursor-not-allowed"
            >
              {isGoogleLoading ? (
            ...
            <button className="flex items-center justify-center gap-2 px-4 py-2.5 border border-zinc-200 rounded-xl hover:bg-zinc-50 transition-all font-bold text-[11px] uppercase tracking-wider text-zinc-700">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="space-y-1">
              <div className="flex justify-between items-center px-1">
                ...
                <button type="button" className="text-[10px] font-black text-indigo-600 uppercase hover:underline">Esqueci a senha</button>
              </div>
              <div className="relative group">
          ...
          <p className="text-center text-[11px] text-zinc-400 font-medium">
            Não tem uma conta? <button className="text-zinc-900 font-bold hover:underline">Contate o administrador</button>
          </p>
        </div>
      </div>

      {/* COLUNA DIREITA: VISUAL/MARKETING */}
      <div className="hidden lg:flex relative bg-zinc-900 overflow-hidden items-center justify-center p-16">
        {/* Efeito de Gradiente/Mesh de Fundo */}
        <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-indigo-600 rounded-full mix-blend-multiply filter blur-[120px] opacity-20 animate-pulse"></div>
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] bg-purple-600 rounded-full mix-blend-multiply filter blur-[100px] opacity-20 animate-pulse delay-700"></div>
        ...
        <div className="relative z-10 space-y-6 max-w-md">
          ...
          <blockquote className="space-y-4">
            <p className="text-4xl font-black text-white leading-tight tracking-tighter">
              "A melhor plataforma para gerenciar seu faturamento em tempo real."
            </p>
          ...
          {/* Mini Dashboard de Exemplo (Decorativo) */}
          <div className="pt-8 grid grid-cols-2 gap-4">
            <div className="bg-white/5 border border-white/10 p-4 rounded-2xl backdrop-blur-sm">
              <p className="text-[10px] font-bold text-zinc-500 uppercase">Vendas Hoje</p>
              <p className="text-xl font-black text-white">+ R$ 12.430</p>
            </div>
            <div className="bg-white/5 border border-white/10 p-4 rounded-2xl backdrop-blur-sm">
              <p className="text-[10px] font-bold text-zinc-500 uppercase">Clientes Ativos</p>
